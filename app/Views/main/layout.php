    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url() ?>/assets/index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">WebApp Gudang</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('satuan/index') ?>" class="nav-link">
                                <i class="fas fa-angle-double-right nav-icon text-warning"></i>
        ...
        <footer class="main-footer">
            ...
            <strong>Design Copyright &copy; 2014-2021 <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights reserved.
        </footer>
